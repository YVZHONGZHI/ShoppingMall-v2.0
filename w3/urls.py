...
urlpatterns = [
    ...
    url(r'^site/(?P<site_name>\w+)/$', views.site, name='site'),
    url(r'^site/(?P<site_name>\w+)/(?P<condition>category|tag|archive)/(?P<param>.*)/', views.site),
    url(r'^site/(?P<site_name>\w+)/goods/(?P<goods_id>\d+)/', views.goods_detail),
